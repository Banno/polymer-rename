  ...
  processDataBindingExpression(dataBoundExpression, startIndex, endIndex) {
    ...
    if (methodParts !== null) {
      ...
      for (let i = 0; i < params.length; i++) {
        ...
        args.push(new renameInfo.RenameableProperty(startIndex + paramStartPosition, startIndex + paramEndPosition,
            params[i].substring(paramStartPosition, paramEndPosition)));
